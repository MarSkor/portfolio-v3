...
import { getProjectsByType } from "@/lib/sanity/queries";
import { urlFor } from "@/lib/sanity/image";
import { AppStoreLogo, GoogleStoreLogo } from "@/components/icons/BrandIcons";
import ScrollReveal from "@/components/ui/ScrollReveal";
import type { ProjectLinkType } from "@/lib/types";


const LINK_ICONS: Partial<
  Record<ProjectLinkType, ComponentType<{ className?: string }>>
> = {
