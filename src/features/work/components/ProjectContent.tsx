...
//       <section className="mx-auto max-w-7xl px-6 lg:px-10 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-3 gap-12">
...
//               <section className="col-span-2 lg:col-span-1 lg:pt-4 lg:border-t lg:border-border/30">
...
const ProjectContent = async ({ slug }: ProjectContentProps) => {
  const project = await getProject(slug);
