...
import type { FullProject, ProjectLink, ProjectLinkType } from "@/lib/types";

const ICONS: Record<ProjectLinkType, LucideIcon | ComponentType<{ className?: string }>> = {
  website: Globe,
  github: GithubLogo,
...
interface StoreLinksProps {
  project: Pick<FullProject, "links">;
  variant?: "buttons" | "badges";
}

const StoreLinks = ({ project, variant = "buttons" }: StoreLinksProps) => {
