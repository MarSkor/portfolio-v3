...
import ProcessGallery from "@/features/work/ProcessGallery";
import StoreLinks from "@/components/ui/StoreLinks";
import ProjectStats from "@/features/work/ProjectStats";
import { getProject, urlFor } from "@/lib/sanity";
import BackLink from "@/components/ui/BackLink";
import TechStack from "@/features/work/ProjectTag";
...
const ProjectDetailPage = async ({ params }) => {
  ...
  return (
    <article className="pt-16">
      ...
      {cover && (
        <section className="grain-exempt mt-10 w-full overflow-hidden border-y border-border">
          <Image
        ...
        <section className="border-t border-border py-16 md:py-20 ">
          <div className="mx-auto max-w-prose-col px-6 lg:px-10">
            ...
            {sections.map((section, i) => (
              <div key={section.label} className={i === 0 ? "" : "mt-14"}>
